...
app.output = function (animalToShow) {
    ...
    image.className = "img-resposnive img-thumbnail";
...
app.save = function () {
    ...
    app.animals[app.currentAnimal].name = breed;
    app.animals[app.currentAnimal].name = habitat;
    app.animals[app.currentAnimal].name = image;
...
app.delete = function () {
    ...
    app.output(app.currentAnimal, 1);
